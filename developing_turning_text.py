...
class Label(displayio.Group):
    ...
    def __init__(
        ...
        self.label_type = label_direction
    ...
    def _create_background_box(self, lines, y_offset):
        ...
        if self._background_tight:  # draw a tight bounding box
            ...
            if self.label_type == "UPR" or self.label_type == "DWR" or self.label_type == "TTB":
    ...
    def _update_text(
        ...
        if self.label_type == "UPR":
            ...
            self._boundingbox = (left, top, right, bottom - top)
        if self.label_type == "DWR":
            print(f"UPR left: {left} top: {top} right: {right} bottom: {bottom}")
            self._boundingbox = (left, top, right, bottom - top)
            print(f"DWR bounding box: {self._boundingbox}")
